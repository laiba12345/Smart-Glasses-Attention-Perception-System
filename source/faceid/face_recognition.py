...
from contrastive_siamese import Siamese
...
siamese.load("faceid/contrastive_out/siamese_model.pt")
siamese.load_prototypes("faceid/contrastive_out/prototypes.csv")
